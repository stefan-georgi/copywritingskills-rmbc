...
```bash
git clone https://github.com/stefan-georgi/copywritingskills-rmbc.git
...
```bash
npx skills add stefan-georgi/copywritingskills-rmbc
```

### 3. Claude Code Plugin

```bash
claude install rmbc-skills
```

### 4. Git Submodule

```bash
git submodule add https://github.com/stefan-georgi/copywritingskills-rmbc.git rmbc-ref
...
```bash
npx skillkit install stefan-georgi/copywritingskills-rmbc
```
